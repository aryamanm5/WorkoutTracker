...
struct AnimatedBodyContainer: View {
    ...
    private func blendedHighlights(progress: Double) -> [Muscle: MuscleHighlight] {
        // When no transition is in flight, render the live highlights directly —
        // the @State copy starts empty and may lag the first layout pass.
        guard progress < 1.0 else { return highlights }
